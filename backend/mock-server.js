...
function generateStudents() {
  ...
  for (let i = 1; i <= 20; i++) {
    ...
    const name = names[Math.floor(Math.random() * names.length)] + nameChars[Math.floor(Math.random() * nameChars.length)];
...
// 学生列表 - 支持 /students, /api/students, /api/v1/students, /v1/students
...
// 教师列表 - 支持 /teachers, /api/teachers, /api/v1/teachers, /v1/teachers
...
// 学生详情 - 支持 /students/:id, /api/students/:id, /api/v1/students/:id, /v1/students/:id
...
// 教师详情 - 支持 /teachers/:id, /api/teachers/:id, /api/v1/teachers/:id, /v1/teachers/:id
...
// 编辑学生 - 支持 /students/:id, /api/students/:id, /api/v1/students/:id, /v1/students/:id
...
// 编辑教师 - 支持 /teachers/:id, /api/teachers/:id, /api/v1/teachers/:id, /v1/teachers/:id
...
// 删除学生 - 支持 /students/:id, /api/students/:id, /api/v1/students/:id, /v1/students/:id
...
// 删除教师 - 支持 /teachers/:id, /api/teachers/:id, /api/v1/teachers/:id, /v1/teachers/:id
...
// 健康检查
app.get(['/api/health', '/api/v1/health', '/v1/health'], (req, res) => {
  res.json(responseSuccess({ status: 'ok' }));
});

// 新增学生 - 支持 /students, /api/students, /api/v1/students, /v1/students
...
// 新增教师 - 支持 /teachers, /api/teachers, /api/v1/teachers, /v1/teachers
