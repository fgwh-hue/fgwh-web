...
onMounted(() => {
  ...
  function getWebGLContext(canvas: HTMLCanvasElement) {
    ...
    if (isWebGL2) {
      ...
      supportLinearFiltering = Boolean((gl as WebGL2RenderingContext).getExtension('OES_texture_float_linear'));
    } else {
    ...
    let formatRGBA: WebGLFormat | null;
    let formatRG: WebGLFormat | null;
    let formatR: WebGLFormat | null;
...
<template>
  <div class="pointer-events-none fixed left-0 top-0 z-50 size-full" :class="[props.class]">
