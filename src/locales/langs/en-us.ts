const local: App.I18n.Schema = {
  ...
  route: {
    ...
    teacher_course: 'Course Management',
    teacher_student: 'Student Management',
    teacher_assignment: 'Assignment Management',
    teacher_analytics: 'Data Analytics',
    login: 'Login',
    403: 'No Permission',
    404: 'Page Not Found',
    500: 'Server Error',
    ...
    manage_student: 'Student Manage',
    manage_teacher: 'Teacher Manage',
  ...
  page: {
    ...
    home: {
      ...
      greetingStudent: 'Student',
      greetingTeacher: 'Teacher',
      greetingAdmin: 'Admin',
