  ...
  <TransitionGroup tag="div" name="setting-list" class="flex-col-stretch gap-12px">
    <SettingItem key="0" :label="$t('theme.resetCacheStrategy.title')">
      <NSelect
        ...
        :options="translateOptions(resetCacheStrategyOptions, $t)"
        size="small"
        class="w-120px"
      />
    </SettingItem>
    <SettingItem key="1" :label="$t('theme.scrollMode.title')">
      <NSelect
        ...
        :options="translateOptions(themeScrollModeOptions, $t)"
        size="small"
        class="w-120px"
      />
    </SettingItem>
    ...
    <SettingItem v-if="themeStore.page.animate" key="1-2" :label="$t('theme.page.mode.title')">
      <NSelect
        ...
        :options="translateOptions(themePageAnimationModeOptions, $t)"
        size="small"
        class="w-120px"
      />
    </SettingItem>
    ...
    <SettingItem v-if="themeStore.tab.visible" key="5-3" :label="$t('theme.tab.mode.title')">
      <NSelect
        ...
        :options="translateOptions(themeTabModeOptions, $t)"
        size="small"
        class="w-120px"
      />
    </SettingItem>
